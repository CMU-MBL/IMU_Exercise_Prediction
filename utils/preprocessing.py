...
def get_data_filename_imu(n_sensors, sensor_pos_1, sensor_pos_2, sensor_mod):
    ...
    Returns:
        filename: filename for the inertial data | str
    """
    if n_sensors > 2:
        filename = 'data_imu_' + str(n_sensors) + '_' + sensor_mod + '.pkl'
    elif n_sensors == 2:
        filename = 'data_imu_' + str(n_sensors) + '_' + sensor_pos_1 + '_' + sensor_pos_2 + '_' + sensor_mod + '.pkl'
    elif n_sensors == 1:
        filename = 'data_imu_' + str(n_sensors) + '_' + sensor_pos_1 + '_' + sensor_mod + '.pkl'
    else:
        pass 
